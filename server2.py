...
class wxCloud:
    ...
    新增数据
    '''
    def add_data(self,id,timeStamp,mood):
        ...
        query = '''
                ...
                ''' % (self.collection,id, mood, timeStamp)
    ...
    更新数据
    '''
    def update_data(self,id,timeStamp,mood):
...
if __name__ == '__main__':
    ...
    APP_SECRET = 'a437b9610c882226e876e1ad07e7a30a'
    ENV = 'test-jpqyt'
    ...
    print(db.query_data(id=ID))  #先查询id是否存在，不存在返回空列表
    if db.query_data(id=ID):
        print(1)
        db.update_data(     #存在则更新
            id=ID,
            timeStamp=[1601731588, 1601731592, 1601731595, 1601731612],
            mood=[0, 4, 1, 1]
        )
    else:
        print(0)
